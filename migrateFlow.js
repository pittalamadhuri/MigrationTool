...
//Declarations
var srcname,tarname,srcstr,tarstr,flowname,newflowid,stepcount,newappid,oldflow,oldflowid,currstep,oldjid,ind,repid,stepid,newvalue;
var newstepids=[];
var oldstepids=[];
var newjids=[];
